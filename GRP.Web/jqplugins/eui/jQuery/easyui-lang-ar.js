...
if ($.fn.tabs) {
    $.fn.tabs.defaults.loadMsg = 'معالجة, الرجاء الإنتظار ...';
}
if ($.messager){
...
$.map(['validatebox','textbox','filebox','searchbox',
		...
		'datebox','hdatebox','datetimebox','numberbox',
...
if ($.fn.calendar){
    $.fn.calendar.defaults.weeks = ['أحد','إثن','ثلا','أربع','خمس','جمعة','سبت']; //['S','M','T','W','T','F','S'];
    $.fn.calendar.defaults.months = ['يناير', 'فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'يوليو', 'أغسطس', 'سبتمبر', 'أكتوبر', 'نوفمبر', 'ديسمبر'];//['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
}
if ($.fn.hcalendar) {
    $.fn.hcalendar.defaults.weeks = ['أحد', 'إثن', 'ثلا', 'أربع', 'خمس', 'جمعة', 'سبت'];
    $.fn.hcalendar.defaults.months = ['محرم', 'صفر', 'ربيع أول', 'ربيع آخر', 'جمادى أول', 'جمادى آخر', 'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'];
}
if ($.fn.datebox){
...
if ($.fn.hdatebox) {
    $.fn.hdatebox.defaults.currentText = 'اليوم';
    $.fn.hdatebox.defaults.closeText = 'إغلاق';
    $.fn.hdatebox.defaults.okText = 'موافق';
}