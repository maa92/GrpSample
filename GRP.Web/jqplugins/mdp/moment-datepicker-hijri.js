...
!function ($, moment, undefined) {
    ...
    Datepicker.prototype = {
        ...
        fill: function () {
            ...
            var prevMonth = moment(year + ' ' + (month + 1) + ' 1', 'hYYYY hMM hDD'); // (month+1) I don't know why the returned value of prevMonth is two months previously not one month :)            
                    ...
                    case 'span':
                        if (!target.is('.disabled')) {
                            if (target.is('.month')) {
                                ...
                                var y = moment(year + '/1/1', 'hYYYY/hM/hD');
                                this.viewDate.year(y.year() + 1);
                    ...
                    case 'td':
                        if (!target.is('.disabled')) {
                            if (target.is('.day')) {
                                ...
                                this.set(moment(year + ' ' + (month + 1) + ' ' + day, 'hYYYY hMM hDD'));
    ...
    DPGlobal.template = '<div class="datepicker dropdown-menu datepicker-rtl">' +
