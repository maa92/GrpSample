(function($) {
    ...
    $.parser = {
        ...
        plugins: ["draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "switchbutton", "progressbar", "tree", "textbox", "filebox", "combo", "combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner", "calendar", "datebox", "hcalendar", "hdatebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid", "datalist", "tabs", "accordion", "window", "dialog", "form"],
        parse: function(_c) {
            var aa = [];
...
(function($) {
    ...
    var _76e = $.extend({}, _760(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "hdatebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
...
(function($) {
    ...
    function _a05(_a06) {
        ...
        } //By Omar27102016,Fix issue that prevent select event handler from being fired when selecting the first (Auto-selected) item in the list
        else {
            item = _a07.children("div.combobox-item-selected");
            if (item.length) {
                var row = opts.finder.getRow(_a06, item);
                var _a08 = row[opts.valueField];
                if (!opts.multiple) {
...
(function($) {
    ...
    $.fn.hdatebox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        formatter: function(_34) {
            ...
            var m = _34.month;
            var d = _34.day;
            return y + "/" + zeroPad(m, 2) + "/" + zeroPad(d, 2);
        },
        parser: function(s) {
            if (!s) {
